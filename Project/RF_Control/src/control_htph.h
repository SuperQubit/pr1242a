...
extern tHTPH_Parameter HTPH_Parameter;
...
extern uint8_t CONTROL_SetVarMaxPower(int8_t val);
extern uint8_t CONTROL_SetVarStimulus(int8_t val);
extern uint8_t CONTROL_SetVarThON(int8_t val);
extern uint8_t CONTROL_SetVarThOFF(int8_t val);
